...
`ep_button_link` runs inside Etherpad's test harness. From an etherpad checkout that has installed this plugin via `pnpm run plugins i --path ../ep_button_link`:
...
* Server: `clientVars`, `loadSettings`
* Client: `aceInitialized`
